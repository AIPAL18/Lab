...
class shared_ptr(ptr[T]):
    ...
    def __new__(cls, obj: Optionalptr[T] = None) -> shared_ptr[T]:
        if cls.class_type() is NoneType:
            cls.__cls_type = type(obj)
...
if __name__ == "__main__":
    ...
    print(shared_ptr.class_type())
    shared_foo = shared_ptr[Foo](Foo(100))
    print(shared_ptr.class_type())
    shared_bar = shared_ptr[Bar](Bar(100))
    print(shared_ptr.class_type())

    # shared_bar = shared_ptr[Bar](Bar(100))
    print(shared_foo.type())
    print(shared_bar.type())
